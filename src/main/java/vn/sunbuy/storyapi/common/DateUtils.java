...
public final class DateUtils {
	...
	public static String toTime(Date date) {
		SimpleDateFormat dateFormat = new SimpleDateFormat(JConstants.TIME_FORMAT);
		try {
			return dateFormat.format(date);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static String toDateHHMI(Date date) {
		...
		try {
			SimpleDateFormat dateFormat = new SimpleDateFormat(JConstants.UI_FORMAT);
	...
	public static long duringDays(Date fromDate, Date toDate) {
		long diff = toDate.getTime() - fromDate.getTime();
		long days = TimeUnit.DAYS.convert(diff, TimeUnit.MILLISECONDS);
		System.out.println(fromDate + " - " + toDate + " = " + days);
		return days;
	}
	...
	public static Date getStartTime(String fromDate) throws ParseException {
		SimpleDateFormat reconcileFormat = new SimpleDateFormat(JConstants.YYYYMMDD);
		Calendar calendar = Calendar.getInstance();
